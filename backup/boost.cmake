...
# 소스 다운로드 및 압축 해제를 건너뛰기 위한 옵션 추가
OPTION(RV_DEPS_BOOST_SKIP_DOWNLOAD "소스 코드 다운로드 및 압축 해제를 건너뛰고, 이미 SOURCE_DIR에 Boost 소스 코드가 있다고 가정합니다." OFF)

MESSAGE(STATUS "RV_DEPS_BOOST_SKIP_DOWNLOAD is OFF. Downloading Boost.")
EXTERNALPROJECT_ADD(
  ${_target}
  DEPENDS Python::Python
  # DOWNLOAD_NAME boost_${_version_with_underscore}.tar.gz
  ...
  BUILD_ALWAYS FALSE # 일반적으로 다운로드 후에는 FALSE, 필요시 TRUE
